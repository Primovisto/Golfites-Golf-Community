...
SECRET_KEY = '-rl*rbql1zag@#&wx#8#)(7l@ajz0p$zvs!wr7h&hs^=bxe(px'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['golfites-golf-community.herokuapp.com', '127.0.0.1', 'localhost']
...
WSGI_APPLICATION = 'Golfites_Golf_Community.wsgi.application'
